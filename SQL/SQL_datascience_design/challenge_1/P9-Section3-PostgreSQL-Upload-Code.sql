...
-- Hit an issue up uploading the CSV into PGadmin 
    -- PROBLEM RESOLVED > Granted postgreSQL access to folders which will need to be accessed
...
-- SELECT is an element that is used to access any table, this is be used a BUTT LOAD OF TIMES
-- Elements are not case sensitive though it is recommended to use all uppercase for elements
